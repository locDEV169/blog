...
function hardCode_Tom_Lai() {
    return <div className="mt-20 xs:mt-14">
        <div className="flex items-end justify-between mb-6 xs:mb-4">
            <div>
                <h2 className="styles_title__2Bx-A  text-black inline-block uppercase m-0 typo-700_40pt">Tóm<br />Lại Là</h2>
        ...
        <div className="styles_s-row__2dAIq styles_spacing-8__cu8EB">
            <div className="styles_s-column__-NKo1 styles_sm__col-2__2wjfk styles_xs__col-1__28DRI styles_spacing-8__1CfRH">
                <article className="w-full tracking-pinned-series-homepagev2-article-1">
                    <div className="relative">
                        <div className="styles_blockImgFeature__h3qPT relative">
                            <a className="tracking-standard-article-detail" title="Phao cứu người, không lấy." style={{ width: '100%', height: '100%' }}>
                                <img src="https://img.vietcetera.com/uploads/images/16-may-2022/tomlaila-guide-1652697656994.jpg" className="aspect-video w-full h-full" />
                                <div className="opacity-90 absolute w-full h-full bottom-0 z-0 rounded-8pt" style={{ background: 'linear-gradient(rgba(0, 0, 0, 0) 40%, rgb(0, 0, 0) 80%)' }}></div>
                            </a>
                        </div>
                        <div className="styles_blockInfoArticle__2-O12 styles_blockInfoArticle_large__2kjHw">
                            <div className="styles_blockTopicTime__32VZ3">
                                ...
                                <div style={{ padding: '0px 8px', color: 'rgb(191, 191, 191)' }}>·</div>
                                <p className="styles_timePublish__3wuyv">17 Thg 05</p>
                            </div>
                            <div className="styles_blockTitleBookmark__2wNok">
                                <h3 className="styles_title__ESIOl styles_title_large__2NhLh">
                                    <a href="#" title="&quot;Phao cứu người, không lấy.&quot;">"Phao cứu người, không lấy."</a>
                                </h3>
                                <div className="styles_blockBtnBookmark__xT-R1 styles_blockBtnBookmark_large__2rN3L">
            ...
            <div className="styles_s-column__-NKo1 styles_sm__col-2__2wjfk styles_xs__col-1__28DRI styles_spacing-8__1CfRH">
                <article className="w-full tracking-pinned-series-homepagev2-article-1">
                    <div className="relative">
                        <div className="styles_blockImgFeature__h3qPT relative">
                            <a className="tracking-standard-article-detail" title="Phao cứu người, không lấy." style={{ width: '100%', height: '100%' }}>
                                <img src="https://img.vietcetera.com/uploads/images/11-may-2022/tomlaila-guide3-1652267538968.jpg" className="aspect-video w-full h-full" />
                                <div className="opacity-90 absolute w-full h-full bottom-0 z-0 rounded-8pt" style={{ background: 'linear-gradient(rgba(0, 0, 0, 0) 40%, rgb(0, 0, 0) 80%)' }}></div>
                            </a>
                        </div>
                        <div className="styles_blockInfoArticle__2-O12 styles_blockInfoArticle_large__2kjHw">
                            ...
                            <div className="styles_blockTitleBookmark__2wNok">
                                <h3 className="styles_title__ESIOl styles_title_large__2NhLh">
                                    <a href="#" title="&quot;Phao cứu người, không lấy.&quot;">My Liberation Notes - Xã hội có đang thiên vị người hướng ngoại?</a>
                                </h3>
                                <div className="styles_blockBtnBookmark__xT-R1 styles_blockBtnBookmark_large__2rN3L">
                                    <button className="tracking-bookmark-undefined">
                                        <BookmarkBorder />
