  ...
  return (
    <div id="__next">
      ...
      <div className="form-account login-page">
        ...
        <p className="text-body-2-light">Nhập email của bạn để ký tài khoản.</p>
        ...
        <div className="form-span author justify-content-center">
          <div>
            <span className="text-body-2">Bạn chưa có tài khoản?</span>
            <span className="secondary left">Đăng ký</span>
          </div>
        </div>
      </div>
    </div>
